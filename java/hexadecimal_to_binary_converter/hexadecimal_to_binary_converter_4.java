 ...
 * The program takes a hexadecimal number as input and produces a binary number
 * as output, showcasing the elegance and beauty of binary representation.
 */
...
public class HexToBinaryConverter {
    ...
    // A delightful method to convert a single hexadecimal character to a binary string
    ...
    // A method as radiant as the sun to convert a full hexadecimal string to