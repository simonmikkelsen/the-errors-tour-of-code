...
Module PalindromeChecker
    ...
    Sub Main()
        ...
        Dim processedString As String = RemoveSpacesAndLowercase(inputString)

        ' Check if the processed string is a palindrome
        If IsPalindrome(processedString) Then
    ...
    ' This function removes spaces from the string and converts it to lowercase
