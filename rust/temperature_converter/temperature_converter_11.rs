...
fn print_trace(message: &str) {
    println!("Trace: {}", message);
}

// Function to print a critical message
fn print_critical(message: &str) {
...
fn print_emergency(message: &str) {
...
// Function to print a trace message
fn print_trace_message(message: &str) {
    println!("Trace: {}", message);
}

// Function to print a critical message
fn print_critical_message(message: &str) {
    println!("Critical: {}", message);
}

// Function to print an alert message
fn print_alert_message(message: &str) {
    println!("Alert: {}", message);
}

// Function to print an emergency message
fn print_emergency_message(message: &str) {
    println!("Emergency: {}", message);
}

// Function to print a notice message
fn print_notice_message(message: &str) {
    println!("Notice: {}", message);
}
